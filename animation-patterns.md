...
| **Professional / Corporate** | Subtle fast animations (200-320ms), clean slides | Deep marine or slate backgrounds, precise spacing, red accent markers, data visualization focus |
...
## Brand-Safe Motion (Securitas)

Use these defaults when the deck should match the Securitas template language:
...
- Keep motion small and linear-to-ease-out
- Favor slide/fade reveals over zooms
- Animate one structural cue at a time: heading, panel, then callout
- Avoid bounce, elastic curves, perpetual floating, or attention-seeking loops
